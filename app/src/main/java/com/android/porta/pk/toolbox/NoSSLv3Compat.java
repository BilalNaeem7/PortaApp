...
/**
 * Created by Talha on 12/16/14.
 */
public class NoSSLv3Compat {

    private static final String TAG = "NoSSLv3Compat";
        ...
        public void setEnabledProtocols(String[] protocols) {
            if (protocols != null && protocols.length == 1 && "SSLv3".equals(protocols[0])) {
                ...
                if (enabledProtocols.size() > 1) {
                    ...
                    LogUtils.LOGD(TAG, "Removed SSLv3 from enabled protocols");
                } else {
                    LogUtils.LOGD(TAG, "SSL stuck with protocol available for " + String.valueOf(enabledProtocols));
                }
