...
public class SmartLog {
	...
	private enum LogMode {
		...
		public void d(String tag, String message, Throwable throwable) {
			...
			case DEBUG_UNTOUCHED:
			case DEBUG_AGGRESSIVE:
				LogUtils.LOGD(tag, message, throwable);
				break;
		...
		public void v(String tag, String message, Throwable throwable) {
			...
			case DEBUG_UNTOUCHED:
			case DEBUG_AGGRESSIVE:
				LogUtils.LOGV(tag, message, throwable);
				break;
		...
		public void w(String tag, String message, Throwable throwable) {
			...
			case DEBUG_PASSIVE:
			case DEBUG_UNTOUCHED:
				LogUtils.LOGW(tag, message, throwable);
				break;
			case DEBUG_AGGRESSIVE:
		...
		public void e(String tag, String message, Throwable throwable) {
			...
			case DEBUG_PASSIVE:
			case DEBUG_UNTOUCHED:
				LogUtils.LOGE(tag, message, throwable);
				break;
			case DEBUG_AGGRESSIVE:
				throwException(tag, message, throwable);
		...
		public void exit_log() {
			...
			case PERFORMANCE_ANALYSIS:
				if (!methodEntryTimestamps
					...
					LogUtils.LOGE(TAG_PERFORMANCE_ANALYSIS,
					...
					Long timeSpentOnMethod = System.currentTimeMillis()
							- methodEntryTimestamps.get(trace[2]
									.getMethodName());
					LogUtils.LOGI(TAG_PERFORMANCE_ANALYSIS,
